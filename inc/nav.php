	...
	<header id="header2">
		<div class="container">
			...
			<div class="menu-wrap">
				...
				<ul class="sf-menu">
					<li>
						<a href="http://localhost/Ecommerce-Website/index.php">Home</a>
					</li>
					<li>
						<a href="http://localhost/Ecommerce-Website/index.php">Shop</a>
					...
					<li>
						<a href="http://localhost/Ecommerce-Website/my-account.php">My Account</a>
						<div class="mobnav-subarrow"><i class="fa fa-plus"></i></div>
						<ul>
							<li><a href="http://localhost/Ecommerce-Website/my-account.php">My Orders</a></li>
							<li><a href="http://localhost/Ecommerce-Website/wishlist.php">My Wishlist</a></li>
							<li><a href="http://localhost/Ecommerce-Website/edit-address.php">Update Address</a></li>
							<li><a href="http://localhost/Ecommerce-Website/logout.php">Logout</a></li>
						</ul>
					</li>
